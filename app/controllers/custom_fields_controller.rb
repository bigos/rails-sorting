class CustomFieldsController < ApplicationController
  ...
  private
    ...
    def custom_field_params
      params.require(:custom_field).permit(:belongs_to_table, :table_record_id, :value_string, :value_integer, :value_boolean, :value_text, :value_decimal, :custom_field_definition_id)
    end
end
